...
<html class="no-js" lang="pt-br">
    ...
    <head>
        ...
        <meta name="marinha" content="Curso para o concurso da marinha">        
...
<!--                        <svg width="40px" height="40px" viewBox="0 0 45 44" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <nav class="collapse navbar-collapse navbar-right" role="Navigation">
                    <ul id="nav" class="nav navbar-nav navigation-menu">
                        ...
                        <li><a data-scroll href="../../#Cursos">Portfolio</a></li>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="col-lg-12">         
                    <blockquote class="mb-50"><li><a href="https://go.hotmart.com/D30312416A">Aprenda agora</a></li></blockquote>                
                </div>
            </div>
        </section>
        <!-- end Contact Area ========================================== -->
